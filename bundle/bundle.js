...
var m=__webpack_require__(3),n=__webpack_require__(6),p=__webpack_require__(4),q="function"===typeof Symbol&&Symbol["for"],r=q?Symbol["for"]("react.element"):60103,t=q?Symbol["for"]("react.call"):60104,u=q?Symbol["for"]("react.return"):60105,v=q?Symbol["for"]("react.portal"):60106,w=q?Symbol["for"]("react.fragment"):60107,x="function"===typeof Symbol&&Symbol.iterator;
...
*/
var aa=__webpack_require__(8),l=__webpack_require__(15),B=__webpack_require__(3),C=__webpack_require__(4),ba=__webpack_require__(16),da=__webpack_require__(17),ea=__webpack_require__(18),fa=__webpack_require__(19),ia=__webpack_require__(20),D=__webpack_require__(6);
...
var MarketGraph = __webpack_require__(41);
...
var App = function (_Component) {
	...
	_createClass(App, [{
		...
		value: function componentDidMount() {
			...
			API.getCrashAnalysis().then(function (data) {
				_this2.setState({ crashdata: data });
			});
		}
	}, {
		key: 'renderBitcoinHistory',
		value: function renderBitcoinHistory() {
...
var _reactGoogleCharts = __webpack_require__(42);
...
var MarketGraph = function () {
	...
	_createClass(MarketGraph, [{
   	...
   	**/
			...
			for (var x = 0; x < data.one.history.length; x++) {
			...
			for (var _x = 0; _x < data.two.history.length; _x++) {
				plotdata.crashtwohistory.push([new Date(data.two.history[_x][0]), data.two.history[_x][4]]);
				plotdata.crashtwocorrelation.push([_x, data.two.correlation[_x]]);
			};

			for (var _x2 = 0; _x2 < data.three.history.length; _x2++) {
				plotdata.crashthreehistory.push([new Date(data.three.history[_x2][0]), data.three.history[_x2][4]]);
				plotdata.crashthreecorrelation.push([_x2, data.three.correlation[_x2]]);
			};
...
var _DEFAULT_CHART_COLORS = __webpack_require__(64);

var _DEFAULT_CHART_COLORS2 = _interopRequireDefault(_DEFAULT_CHART_COLORS);

var _GoogleChartLoader = __webpack_require__(65);
...
var script = typeof window !== 'undefined' ? __webpack_require__(66) : function (link, _ref) {
...
var API = function () {
	...
	_createClass(API, [{
		key: 'getCrashAnalysis',
		value: function getCrashAnalysis() {
			return fetch('/api', {
				method: 'get',
				mode: 'cors'
